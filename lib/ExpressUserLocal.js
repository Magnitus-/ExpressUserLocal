...
module.exports = function(Options)
{
    ...
    var HideRestricted = Options && Options.HideRestricted ? Options.HideRestricted : true;
    ...
    return function(Router) {
        ...
        if(Roles&&Roles.Get)
        {
            ...
            Router.get('/User/:Field/:ID', ValidationRoutes.UserGET(UserSchema, HideRestricted));
        }
